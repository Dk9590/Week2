...
//	   Leaf$1234
    ...
    WebElement EditLead = driver.findElement(By.linkText("subMenuButton"));
    EditLead.click();
    ...
    updateImportantNote.clear();
    WebElement ClickUpdate = driver.findElement(By.id("ext-gen624"));
    ClickUpdate.click();
    String title1= driver.getTitle();
    title1.equals("View Lead");
    driver.close();
}
}
